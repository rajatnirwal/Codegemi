        ...
        <div className="w-full md:w-2/5 bg-gradient-to-br from-blue-600 to-indigo-800 p-8 flex flex-col justify-center items-center text-white">
          <div className="mb-6">
            ...
            <p className="text-blue-100">
              Where developers unite and collaborate
            </p>
          </div>
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2 bg-gray-700 border rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 ${
          ...
          {isLogin && (
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-400">
                Demo Login: try{" "}
                <span className="text-indigo-400">demo@example.com</span> /{" "}
                <span className="text-indigo-400">anypassword</span>
              </p>
              <p className="text-sm text-gray-400 mt-1">
                Or try <span className="text-indigo-400">test@test.com</span> /{" "}
                <span className="text-indigo-400">test123</span>
              </p>
            </div>
          )}
        </div>
