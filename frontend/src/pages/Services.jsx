...
const Services = () => {
  ...
  // ✅ Data section (kept together neatly)
  const services = [
    {
      id: 1,
    ...
    },
    {
      ...
      icon: assets.WebDevelopmentServicePage,
    },
    {
      id: 5,
      slug: "digital-marketing",
      title: "Digital Marketing",
      icon: assets.DigitalMarketingServicePage,
    },
    {
      id: 6,
      slug: "graphic-design",
      title: "Graphic Design",
      icon: assets.GraphicDesignServicePage,
    },
    {
      id: 7,
      slug: "data-analysis",
      title: "Data Analysis",
      icon: assets.DataAnalysisServicePage,
    },
    {
      id: 8,
      slug: "seo-optimization",
      title: "SEO Optimization",
      icon: assets.SEOServicePage,
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "We offer software development, web design, RPA automation, digital marketing, and more tailored IT services.",
    },
    {
      question: "How can I contact your team?",
      answer:
        "You can reach us through our contact form, email, or by phone. We respond within 24 hours.",
    },
    {
      question: "Do you provide post-launch support?",
      answer:
        "Yes! We offer long-term maintenance and technical support after deployment.",
    },
  ];
  ...
  return (
    <div className="font-sans overflow-hidden">
      ...
      <section
        ...
        style={{
          backgroundImage: `url(${assets.ServicePageBanner})`,
        }}
      >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service) => (
              <div
                ...
                className="bg-white shadow-md rounded-2xl p-8 hover:shadow-xl cursor-pointer transition-all"
              >
                <img
                  src={service.icon}
                  alt={service.title}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <button
              type="submit"
              className="sm:col-span-2 bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg font-semibold transition"
            >
              Send Message
            </button>
          </form>
