...
import CodeGemiLogo from "../assets/img/CG LOGO final 3.png"; // Updated import
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center h-full px-6 lg:px-12">
        {/* Logo - Size fixed for both scrolled and non-scrolled states */}
        <div className="flex items-center z-60 h-full">
          <Link
            to="/"
          ...
          >
            <img
              src={CodeGemiLogo}
              alt="CodeGemi Logo"
              className="h-28 transition-all duration-500 bg-transparent mix-blend-multiply"
              // Increased size to h-28 and added transparent background
            />
          </Link>
        </div>
...
// import React, { useState, useEffect, useRef } from "react";
// import { assets } from "../assets/assets";
// import ServicesDropdown from "./ServicesDropdown"; // Uncommented this line
